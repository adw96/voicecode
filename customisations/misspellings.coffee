...
Commands.addMisspellings('chuck', ['common:enter'])
...
Commands.addMisspellings('champion', ['format:capitalize-next-word'])
Commands.addMisspellings('temp', ['format:capitalize-next-word'])
Commands.addMisspellings('yellow', ['format:upper'])

# symbols
Commands.addMisspellings('charles', ['symbols:backslash'])
Commands.addMisspellings('shells', ['symbols:backslash'])
...
# repetition
Commands.addMisspellings('apple', ['repetition:command'])
